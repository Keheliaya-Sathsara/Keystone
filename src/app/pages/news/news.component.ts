...
newses: news[] = [
    ...
    },
    {
      ...
      link: '2',
      content: 'Keystone Technologies International accelerates infrastructure and tech growth through strategic global partnerships.',
      iconHref: 'https://www.oceanwatch.lk',
      button1: { label: 'UI/UX', href: 'https://www.oceanwatch.lk', class: 'btn-1' },
      button2: { label: 'Research', href: 'https://www.oceanwatch.lk', class: 'btn-2' },
      button3: { label: 'Presentation', href: 'https://www.oceanwatch.lk', class: 'btn-3' },
    ...
    },
    {
      ...
      link: '13',
      content: 'WIN WAY is Sri Lanka’s first fully digital national lottery platform, developed by Keystone Technologies and Cubematrix to modernize access, boost transparency, and support national development.',
      iconHref: 'https://www.oceanwatch.lk',
      button1: { label: 'UI/UX', href: 'https://www.oceanwatch.lk', class: 'btn-1' },
      button2: { label: 'Research', href: 'https://www.oceanwatch.lk', class: 'btn-2' },
      button3: { label: 'Presentation', href: 'https://www.oceanwatch.lk', class: 'btn-3' },
